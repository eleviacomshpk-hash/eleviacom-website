...
const faqs = [
  {
    question: "Quanto costa implementare l'AI nella mia azienda?",
    answer:
      "I nostri progetti partono da \u20AC2.000 per automazioni semplici fino a \u20AC25.000 per architetture AI complete. Il costo dipende dalla complessit\u00E0. Offriamo sempre una consulenza gratuita per valutare insieme il budget ottimale.",
    meta: "Prezzi",
  },
  {
    question: "Quanto tempo ci vuole per implementare?",
    answer:
      "Un chatbot semplice richiede 2\u20134 settimane. Un sistema di automazione completo richiede 4\u20138 settimane. Iniziamo sempre con un progetto pilota per dimostrare risultati rapidi.",
    meta: "Tempi",
  },
  {
    question: "Serve competenza tecnica nel mio team?",
    answer:
      "No. Progettiamo soluzioni AI che il tuo team pu\u00F2 usare senza competenze tecniche. Forniamo formazione completa e supporto continuo. Non serve un team IT dedicato.",
    meta: "Accessibilit\u00E0",
  },
  {
    question: "I miei dati sono al sicuro?",
    answer:
      "Assolutamente s\u00EC. Siamo conformi al GDPR e al Regolamento EU sull\u2019AI. Tutti i dati sono protetti con crittografia e Clausole Contrattuali Standard per i trasferimenti internazionali.",
    meta: "Sicurezza",
  },
  {
    question: "L'AI funziona per il mio settore?",
    answer:
      "L\u2019AI \u00E8 efficace in qualsiasi settore con processi ripetitivi o interazione con i clienti: retail, manifattura, servizi professionali, ristorazione, edilizia, sanit\u00E0. Il 42% delle PMI italiane investir\u00E0 in AI entro il 2026.",
    meta: "Settori",
  },
  {
    question: "L'AI sostituir\u00E0 i miei dipendenti?",
    answer:
      "No. L\u2019AI automatizza le attivit\u00E0 ripetitive e a basso valore, liberando il tuo team per concentrarsi su relazioni con i clienti, creativit\u00E0 e decisioni strategiche. Il dipendente AI potenzia il team, non lo sostituisce.",
    meta: "Team",
  },
];
...
const palettes = {
  dark: {
    ...
    aurora: "radial-gradient(ellipse 80% 60% at 30% 0%, rgba(226, 232, 240, 0.12), transparent 50%), #000000",
...
function FAQ1() {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-black text-neutral-100">
      <section
        className={`relative z-10 mx-auto flex max-w-4xl flex-col gap-8 md:gap-12 px-4 py-12 md:py-24 lg:max-w-5xl lg:px-12 ${
      ...
      >
        ...
        <header className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div className="space-y-4 text-center md:text-left">
            <p className={`text-xs uppercase tracking-[0.35em] ${palette.muted}`}>Domande Frequenti</p>
            <h1 className={`text-3xl font-semibold leading-tight md:text-5xl ${palette.heading}`}>
              Tutto quello che devi sapere.
            </h1>
            <p className={`max-w-xl mx-auto md:mx-0 text-sm md:text-base ${palette.muted}`}>
              Le risposte alle domande pi&ugrave; comuni sull&apos;AI per le PMI italiane.
            </p>
          </div>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="relative flex w-full items-start gap-4 md:gap-6 px-5 md:px-8 py-5 md:py-7 text-left transition-colors duration-300"
                >
                  <span
                  ...
                  <div className="flex flex-1 flex-col gap-4">
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                      <h2 className={`text-base font-medium leading-tight sm:text-lg md:text-xl ${palette.heading}`}>
                        {item.question}
                      </h2>
                      {item.meta && (
                        <span
